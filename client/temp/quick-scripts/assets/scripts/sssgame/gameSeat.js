(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/sssgame/gameSeat.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'b69d3cyleNLV4L1rQ3BQ+6M', 'gameSeat', __filename);
// scripts/sssgame/gameSeat.js
...
cc.Class({
    ...
    resetGameSeat: function resetGameSeat() {
        for (var i = 0; i < this.arrScoreNodeZ.length; i++) {
            this.arrScoreNodeZ[i].active = false;
        }
        for (var _i2 = 0; _i2 < this.arrScoreNodeF.length; _i2++) {
            this.arrScoreNodeF[_i2].active = false;
        }
        for (var _i3 = 0; _i3 < this.arrFuHaoNode.length; _i3++) {
            this.arrFuHaoNode[_i3].active = false;
        }
        for (var _i4 = 0; _i4 < this.arrTeXiaoNode.length; _i4++) {
            this.arrTeXiaoNode[_i4].active = false;
        }
        for (var _i5 = 0; _i5 < this.arrScoreLabelZ.length; _i5++) {
            this.arrScoreLabelZ[_i5].string = 0;
        }
        for (var _i6 = 0; _i6 < this.arrScoreLabelF.length; _i6++) {
            this.arrScoreLabelF[_i6].string = 0;
        }

        for (var _i7 = 0; _i7 < this.arrNode.length; _i7++) {
            this.arrNode[_i7].active = false;
        }
        this.beShoot.active = false;
        this.doShoot.active = false;
        this.teshupaiNode.active = false;
