(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/sssgame/sss_seat.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '8be0dH71qREoasU1uxSKY7P', 'sss_seat', __filename);
// scripts/sssgame/sss_seat.js
...
cc.Class({
    ...
    properties: (_properties = {
        ...
        _isZhuang: false,
        _userId: null
    }, _defineProperty(_properties, "_ready", null), _defineProperty(_properties, "_headBox", null), _defineProperty(_properties, "touxiangkuang", null), _defineProperty(_properties, "numAtlas", {
        default: null,
        type: cc.SpriteAtlas
    }), _properties),
    ...
    showPlayerInfo: function showPlayerInfo(isShowPaibei) {
        this.paiBeiNode.active = isShowPaibei;
        this.liPaiNode.active = !isShowPaibei;
    },

    //发牌动画
    fapaiAnimation: function fapaiAnimation(index) {
        var animation = window.sssGame.Animation;
    ...
    //改变发牌动画位置
    setfapaiPosition: function setfapaiPosition(eff, index) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=sss_seat.js.map
