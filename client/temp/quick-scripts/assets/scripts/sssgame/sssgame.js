(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/sssgame/sssgame.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddd1b9MLHpJRoX0Jc24R1AP', 'sssgame', __filename);
// scripts/sssgame/sssgame.js
    ...
    onBtnClick: function onBtnClick(event) {
        ...
        if (event.target.name == "btn_mianban") {
            ...
            if (cc.sys.browserType == "mqqbrowser" || "wechat" == cc.sys.browserType) {
                ...
                this.shareUrl("斗斗福建十三水", "小伙子，我在十三水" + "(" + SSSwanfa + ")" + "【" + cc.vv.sssNetMgr.roomId + "】开好了房间，快来大战三百回合", "http://game.doudouyule.wang/?roomId=" + cc.vv.sssNetMgr.roomId, "http://game.doudouyule.wang/icon.png", "0"); //标题 内容 URL 图片路径 发送至
            }
            //其它浏览器----二维码扫码登录 
            else {
                    console.log("H5分享好友");
