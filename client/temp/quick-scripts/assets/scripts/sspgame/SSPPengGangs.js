(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/sspgame/SSPPengGangs.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'e6f7fEPWqNPvaUQbxQrTO5y', 'SSPPengGangs', __filename);
// scripts/sspgame/SSPPengGangs.js
...
cc.Class({
    ...
    onPengGangChanged: function onPengGangChanged(seatData, type, redundantPai) {
        ...
        if (liangpais) {
            for (var i = 0; i < liangpais.length; ++i) {
                ...
                var TYPE = null;
                if (liangpais[i].type && liangpais[i].type === "jinLong") {
                    //牌的长度
                    TYPE = "jinlong";
                } else if (sspid.length === 4 && i < seatData.jinlongLen) {
                    //牌的长度
                    TYPE = "jinlong";
                } else if (sspid.length === 4 && sspid[0].type == sspid[1].type) {
                    //牌的长度
                    TYPE = "gang";
                } else {
                    TYPE = "chi";
                ...
                if (i === liangpais.length - 1 && redundantPai) {
                    //最后一项 显示标记
    ...
    prompt: function prompt(pengangroot, side, seatData, Pai, redundantPai, index, liangpais) {
        //显示标记
    ...
    initliangpais: function initliangpais(pengangroot, side, pre, index, sspid, type, flag) {
        var pgroot = null;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=SSPPengGangs.js.map
