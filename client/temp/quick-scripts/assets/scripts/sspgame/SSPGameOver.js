(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/sspgame/SSPGameOver.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'cc04bDEqXRFxaSptj5iGl+u', 'SSPGameOver', __filename);
// scripts/sspgame/SSPGameOver.js
...
cc.Class({
    ...
    onGameOver: function onGameOver(data) {
        ...
        for (var i = 0; i < seats.length; ++i) {
            ...
            if (!userData.type || userData.type === 'draw') {
                ...
                for (var m = 0; m < userData.holds.longPai.length; m++) {
                    //获取所有锁牌的index
                ...
                if (userData.score.yinLongFan > 0 && userData.score.jinLongFan > 0) {
                    ziTi = "[番X" + userData.score.fan + "   金龙X" + userData.score.jinLongFan + "   银龙X" + userData.score.yinLongFan + "   底X3]X" + userData.multiple + huType;
                } else if (userData.score.yinLongFan > 0 && userData.score.jinLongFan <= 0) {
                    ziTi = "[番X" + userData.score.fan + "   银龙X" + userData.score.yinLongFan + "   底X3]X" + userData.multiple + huType;
                } else if (userData.score.jinLongFan > 0 && userData.score.yinLongFan <= 0) {
                    ziTi = "[番X" + userData.score.fan + "   金龙X" + userData.score.jinLongFan + "   底X3]X" + userData.multiple + huType;
                } else {
    ...
    onBtnReadyClicked: function onBtnReadyClicked(event) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=SSPGameOver.js.map
