(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/sspgame/sspGameSeats.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'c33e9NFpbRIe4Y+SaJjOOaO', 'sspGameSeats', __filename);
// scripts/sspgame/sspGameSeats.js
...
cc.Class({
    ...
    initSSP: function initSSP(_mySSPArr) {
        //手牌
    ...
    onGameBeign: function onGameBeign(_mySSPArr) {
        this.reset();
    ...
    resetHolds: function resetHolds() {
        var gameChild = cc.find("Canvas/game");
    ...
    onGameHolds: function onGameHolds(_mySSPArr, Animation) {
        //发牌动画
        var self = this;
        var seats = cc.vv.sspNetMgr.seats;
    ...
    initOtherSSP: function initOtherSSP(seatData) {
    ...
    //点击吃按钮会判断左吃右吃中吃
    CheckCanChi: function CheckCanChi(Pai) {
        if (!Pai) {
            return;
        }
    ...
    getSSPIndex: function getSSPIndex(side, index, seatindex) {
    ...
    showMopai: function showMopai(data) {
        if (data.pai.value >= 0) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=sspGameSeats.js.map
