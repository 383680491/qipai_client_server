(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/SSPMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '77f19jDe79DHLx7AwsRyBF9', 'SSPMgr', __filename);
// scripts/SSPMgr.js
...
cc.Class({
    ...
    getSpriteFrameByPai: function getSpriteFrameByPai(pre, pai) {
    ...
    getAudioURLByPai: function getAudioURLByPai(id) {
        var realId = 0;
        if (id >= 0 && id < 9) {
            realId = id + 21;
        } else if (id >= 9 && id < 18) {
    ...
    sortSSP: function sortSSP(arrPai) {
        var self = this;
        if (arrPai) {
    ...
    sortSSPF: function sortSSPF(arrPai) {
        var self = this;
        if (arrPai) {
            arrPai.sort(function (a, b) {
                var t1 = self.getSSPType(a);
...
cc._RF.pop();
        ...
        //# sourceMappingURL=SSPMgr.js.map
