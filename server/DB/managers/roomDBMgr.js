...
roomDBMgr.is_room_exist = function(roomId,callback){
...
roomDBMgr.create_room = function(roomId,conf,ip,port,create_time,callback){
    callback = callback == null? nop:callback;
...
roomDBMgr.get_room_uuid = function(roomId,callback){
    callback = callback == null? nop:callback;
...
roomDBMgr.update_seat_info = function(roomId,seatIndex,userId,icon,name,callback){
    callback = callback == null? nop:callback;
...
roomDBMgr.update_num_of_turns = function(roomId,numOfTurns,callback){
    callback = callback == null? nop:callback;
...
roomDBMgr.update_next_button = function(roomId,nextButton,callback){
    callback = callback == null? nop:callback;
...
roomDBMgr.get_room_addr = function(roomId,callback){
    callback = callback == null? nop:callback;
    if(roomId == null){
...
roomDBMgr.get_room_data = function(roomId,callback){
    callback = callback == null? nop:callback;
    if(roomId == null){
        callback(null);
        return;
...
roomDBMgr.delete_room = function(roomId,callback){
    callback = callback == null? nop:callback;
    if(roomId == null){
        callback(false);
    }
